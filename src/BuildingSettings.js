...
export const goodsData = {
    ...
    shovels: {ingredients: {plastic: 1, metal: 1, wood: 1}, duration: 1800, building: 'Hardware Store', price: 150, shortcut: 'sh', storeFrequency: 0, requiredLevel: 9, display: 'utensils'},
    ...
    'garden furniture': {ingredients: {plastic: 2, textiles: 2, planks: 2}, duration: 8100, building: 'Gardening Supplies', price: 820, shortcut: 'of', storeFrequency: 0, requiredLevel: 21, display: 'lswn chairs'},
    'fire pits': {ingredients: {bricks: 2, shovels: 1, cement: 2}, duration: 14800, building: 'Gardening Supplies', price: 1740, shortcut: 'fp', storeFrequency: 3, requiredLevel: 28, display: 'mowers'},
    ...
    'bread rolls': {ingredients: {flour: 2, cream: 1}, duration: 3600, building: 'Donut Shop', price: 1840, shortcut: 'br', storeFrequency: 0, requiredLevel: 24, display: 'rools'},
    'cherry cheesecake slices': {ingredients: {flour: 1, 'fruit and berries': 1, cheese: 1}, duration: 5400, building: 'Donut Shop', price: 2240, shortcut: 'cc', storeFrequency: 3, requiredLevel: 27, display: 'cheesecake'},
    ...
    'tennis rackets': {ingredients: {minerals: 4, hammers: 2}, duration: 2700, building: 'Sports Shop', price: 2000, shortcut: 'tr', storeFrequency: 0, requiredLevel: 35, display: 'rackets'},
    'sports drink': {ingredients: {fruit: 2, 'sugar and spices': 4}, duration: 2100, building: 'Sports Shop', price: 2000, shortcut: 'sd', storeFrequency: 0, requiredLevel: 35},
    'football shoes': {ingredients: {shoes: 1, chemicals: 3}, duration: 2100, building: 'Sports Shop', price: 2000, shortcut: 'fs', storeFrequency: 0, requiredLevel: 35, display: 'cleats'},
    'protien bar': {ingredients: {'cherry cheesecake slices': 1, 'sugar and spices': 2}, duration: 14400, building: 'Sports Shop', price: 2000, shortcut: 'pb', storeFrequency: 0, requiredLevel: 35, display: 'bars'},
    'ping pong table': {ingredients: {'electrical components': 1, drills: 1, nails: 3}, duration: 14400, building: 'Sports Shop', price: 2000, shortcut: 'pp', storeFrequency: 0, requiredLevel: 35},
