const goods = {
    ...
    hammers: {ingredients: {metal: 1, wood: 1}, duration: 756, building: 'Hardware Store', prices: [67, 90], shortcut: 'hm'},
    'measuring tapes': {ingredients: {plastic: 1, metal: 1}, duration: 1080, building: 'Hardware Store', prices: [82, 110], shortcut: 'mt'},
    shovels: {ingredients: {plastic: 1, metal: 1, wood: 1}, duration: 1620, building: 'Hardware Store', prices: [112, 150], shortcut: 'sh'},
    utensils: {ingredients: {plastic: 2, metal: 2, wood: 2}, duration: 2430, building: 'Hardware Store', prices: [187, 250], shortcut: 'ut'},
    ladders: {ingredients: {metal: 2, 'wood planks': 2}, duration: 3240, building: 'Hardware Store', prices: [315, 420], shortcut: 'ld'},
    drills: {ingredients: {metal: 2, plastic: 2, 'electrical components': 1}, duration: 6480, building: 'Hardware Store', prices: [442, 590], shortcut: 'dr'},
    ...
    'red shoes': {ingredients: {plastic: 1, glue: 1, 'toilet paper rolls': 1}, duration: 4020, building: 'Fashion Store', prices: [735, 980], shortcut: 'rs'},
